...
There are three vignettes included with this package which will walk through different examples of cleaning quadrat data. The \code{\link{cleaning_simple.Rmd}} vignette will produce data which is visualizable with [this example shiny app](https://dominiquemaucieri.shinyapps.io/example/).

```{r, message = FALSE, out.width = '45%', fig.show='hold'}
...
Additionally you can contact me with further inquiries at \email{dominiquemaucieri@gmail.com}
