...
to do: Needs to answer what the package does, why to use it, how to use it, how to get it 
...
Check out [this example shiny app](https://dominiquemaucieri.shinyapps.io/example/)
