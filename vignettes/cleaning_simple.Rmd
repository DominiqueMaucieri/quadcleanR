...
Visualizing the data can be easy with a built in shiny app function. To see an example shiny app you can go [here](https://dominiquemaucieri.shinyapps.io/example/). The data used in this example is this data set. However this does not help you as this is not your own data. You can use the following code to produce a shiny app of your data, which you can then explore your data. 

```{r shiny app}

# visualize_app(data = simple_cleaned, independent = colnames(simple_cleaned[,1:13]), dependent = "prop_cover")

```

Note: if you do not provide data, the example data that was shown [here](https://dominiquemaucieri.shinyapps.io/example/) will be the data used. 
