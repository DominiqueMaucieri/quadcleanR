...
By identifying how many useable points there are in each quadrat, and removing any quadrats that had over 10% of the identified points unuseable, we have removed 175 quadrats from analysis, which you can view with the `SQuad_removed` data frame.
...
AllQuad <- smartbind(SQuad_removed, LQuad_noMPQ, fill = 0)
