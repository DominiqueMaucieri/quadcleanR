...
This vignette will walk you through the different functions for cleaning quadrat data within the 
'quadcleanR' package. 
...
## 4. rm_chr()
Parts of characters can be removed based on a vector of removal characters. When workingwith images, this can be helpful to remove extra characters from image IDs, or anywhere else where you want to remove specific characters from your data. 
...
corals_usable_obs <- usable_obs(corals_cover_calc, c("Unclear", "Shadow"), max = TRUE, cutoff = 0.9, print_max = FALSE, rm_unusable = TRUE)
...
# corals_sample_size <- sample_size(corals_usable_obs, dim_1 = "Field.Season", dim_2 = "Site", count = "Quadrat")
